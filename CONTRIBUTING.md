...
Discussion of this work occurs on the [Taking IP To Other Planets
Working Group mailing list](mailto:deepspace@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/deepspace),
[subscribe](https://mailman3.ietf.org/mailman3/lists/deepspace.ietf.org/)).
...
[Working Group documents](https://datatracker.ietf.org/wg/tiptop/documents/).
